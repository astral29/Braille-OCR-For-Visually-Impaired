...
import time
#from docx import Document #if you want to export data to a doc file
import serial

Arduinouno_Serial = serial.Serial('COM4',9600)
...
while True:
    ...
    key = cv2.waitKey(1)
    if key == 27:
        cv2.imwrite("123.jpg", wrapped)
        break

cap.release()    
cv2.destroyAllWindows()

filename = "C:\\Users\\Ashish\\Desktop\\DV\\OCR\\123.jpg" #location where image captured from camera is saved
